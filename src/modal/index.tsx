...
export interface ModalProps extends Omit<AntModalProps, 'onOk' | 'confirmLoading' | 'visible'> {
    ...
    onOk?: (event: React.MouseEvent<HTMLElement, MouseEvent>) => Promise<boolean | void> | boolean | void
    /** 点击取消按钮后触发的事件 */
    onCancel?: (event: React.MouseEvent<HTMLElement, MouseEvent>) => Promise<boolean | void> | boolean | void
    /** 改变显示状态 */
